// The Don't Cafe - Matthew So & Jannie Li
// APCS1 pd10
...
public class Rational{
	...
	//rational number (formatting of your choice)
	...
	//(which is double btw i think-EM)
	...
	//Takes 1 Rational object as a parameter and multiplies
	//it by this Rational object
	//Does not return any value
	//Should modify this object and leave the parameter
	//alone (see below for example)
	...
	Rational inverse = new Rational(divisor.getDenominator(),
	...
	//for the case that the larger number is divisible
    ...
    //takes no inputs and returns gcd of the current
    //numerator and denominator of the instance of class
    public int gcd(){
    ...
    //Returns a positive integer if the calling number is
    //larger than the parameter
    // Returns a negative integer if the calling number is
	...
	if (other.getClass() == this.getClass()){
	    ...
	    this.reduce();
	    if (this.numerator == newother.numerator &&
		this.denominator == newother.denominator)
